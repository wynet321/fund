...
public interface PriceRepo extends JpaRepository<Price, PriceIdentity> {
    ...
    Page<Price> findLatestPrice(@Param("fundId") String fundId, Pageable pageable);
    ...
    Price findLatestPrice(@Param("fundId") String fundId, @Param("targetDate") LocalDate targetDate);
    ...
    Price findEarliestPrice(@Param("fundId") String fundId, @Param("targetDate") LocalDate targetDate);
