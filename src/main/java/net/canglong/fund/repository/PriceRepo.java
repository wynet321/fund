...
public interface PriceRepo extends JpaRepository<Price, PriceIdentity> {
    ...
    Price findLatestPriceBeforeDate(@Param("fundId") String fundId, @Param("targetDate") LocalDate targetDate);
    ...
    Price findEarliestPriceAfterDate(@Param("fundId") String fundId, @Param("targetDate") LocalDate targetDate);
