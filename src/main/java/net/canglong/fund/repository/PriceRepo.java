...
public interface PriceRepo extends JpaRepository<Price, PriceIdentity> {
    ...
    Page<Price> findPriceSet(@Param("fundId") String fundId, @Param("startDate") LocalDate startDate, Pageable pageable);
    ...
    Page<Price> findLatestPriceAfterDate(@Param("fundId") String fundId, Pageable pageable);
    ...
    Price findLatestPriceAfterDate(@Param("fundId") String fundId, @Param("targetDate") LocalDate targetDate);
    ...
    Price findEarliestPriceBeforeDate(@Param("fundId") String fundId, @Param("targetDate") LocalDate targetDate);
